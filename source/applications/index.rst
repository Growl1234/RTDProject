...
这里收录了一些关于如何应用计算化学和使用计算化学程序的资料，其中包含大量外部链接。:raw-html:`<span style="color:red;"><strong>最底下的“推荐博客及论坛”一定不要忘记收藏！</strong></span>` 
...
此外，卢天老师也针对不同层次和领域的计算化学学习者和研究者开设了性价比超高的计算化学培训班（见 `🔗北京科音举办的培训简介 <http://www.keinsci.com/workshop.html>`_ ），感兴趣且愿意进一步学习的可以考虑。
