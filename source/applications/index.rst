...
特别注意，最后面“推荐博客及论坛”所列出的**“思想家公社”和“计算化学公社”是国内最顶级、最专业的计算化学博客网站和论坛网站，没有之一！**无论你是新手还是老手，都可以在里面找到非常有用、有价值的信息，以及参与该专业领域的讨论。不过博客和论坛大都还是聚焦于应用型计算和比较典型的任务类型，如果你的研究领域特别高深（比如量子动力学），那么这些论坛对你的实际帮助可能就不是特别明显了。
